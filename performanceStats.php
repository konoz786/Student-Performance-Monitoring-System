...
.nav-side-menu li a {
  ...
  <body>
    ...
    <div class="brand"><b>GPA Analysis</b></div>
  ...
  <ul id="menu-content" class="menu-content collapse out">
        ...
        <li>
        <a href="courseWisePerformance.php">
        <i class="fa fa-check fa-lg"></i> Course-wise
        </a>
        </li>

        <li>
        <a href="instructorWisePerformance.php">
        <i class="fa fa-check fa-lg"></i> Instructor-wise
        </a>
        </li>
