...
.nav-side-menu li a {
  ...
  <ul id="menu-content" class="menu-content collapse out">
      ...
      <li  data-toggle="collapse" >
        <a href="createCourseOutline.php"><i class="fa fa-check fa-lg"></i> Create course outline <span class="arrow"></span></a>
      </li>
     

                <li>
                  <a href="viewCourseOutline.php">
                  <i class="fa fa-check fa-lg"></i> View course outline</li>
                  </a>
                <li>
                  <a href="logout.php">
