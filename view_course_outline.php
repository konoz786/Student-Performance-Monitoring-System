...
body{
  ...
  <div style="display:flex;justify-content:space-evenly;">
    ...
    <select style="width:200px;margin-top:100px;margin-left:300px;" name="courseID" class="select">
    ...
    <select style="width:200px;margin-top:100px;" name="sectionNum" class="select">
    ...
    <select style="width:200px;margin-top:100px;" name="semester" class="select">
    ...
    <select style="width:200px;margin-top:100px;" name="year" class="select">
  ...
  <input style="margin-top:100px;margin-left:200px;width:200px;" type="submit" value="Submit" name="submit" class="select">
  </div> 
